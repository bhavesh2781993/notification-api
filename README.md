...
```
cd existing_repo
git remote add origin https://gitlab.com/i2872/ezbytz-common/notification-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/i2872/ezbytz-common/notification-api/-/settings/integrations)
